...
const BASKETBALL_CLUBS: ClubSeed[] = [
  ...
  c("bb-miami-tide", "마이애미 타이드", "Miami Tide", "MTD", "bb-na", "US", 82, "#98002E"),
  ...
  c("bb-bologna-reds", "볼로냐 레즈", "Bologna Reds", "BLR", "bb-global", "IT", 80, "#BE0A26"),
  c("bb-telaviv-lions", "텔아비브 라이언스", "Tel Aviv Lions", "TAL", "bb-global", "IL", 80, "#F7D417"),
  c("bb-kaunas-amber", "카우나스 앰버", "Kaunas Amber", "KAM", "bb-global", "LT", 79, "#006A44"),
...
const PICKLEBALL_CLUBS: ClubSeed[] = [
  ...
  c("pb-dallas-courts", "댈러스 코츠", "Dallas Courts", "DLC", "pb-pro", "US", 79, "#003594"),
  c("pb-vegas-volley", "베이거스 발리", "Vegas Volley", "VGV", "pb-pro", "US", 78, "#B4975A"),
  c("pb-denver-drop", "덴버 드롭", "Denver Drop", "DVD", "pb-pro", "US", 77, "#0E2240"),
  ...
  c("pb-sydney-slices", "시드니 슬라이스", "Sydney Slices", "SYS", "pb-open", "AU", 74, "#00843D"),
